...
(function (factory) {
    ...
    Navigator.prototype.enableMouse = function () {
        ...
        this.$mouseleaveHandler = function (event) {
            self.$container.classList.remove("mouse-over")
        };

        this.elements().forEach(function(element, index){
            element.addEventListener('mouseenter', self.$mouseenterHandler);
            element.addEventListener('mouseleave', self.$mouseleaveHandler);
        });
    };

    Navigator.prototype.deselectAll = function () {
        var self = this;
        this.$container.classList.remove("mouse-over")
        this.elements().forEach(function(element, index){
            removeClass(element, self.$options.selected);
        });
    };
